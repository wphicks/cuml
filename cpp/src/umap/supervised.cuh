...
{
  dim3 grid(raft::ceildiv(static_cast<uint64_t>(graph_coo->nnz), TPB_X), 1, 1);
  dim3 blk(TPB_X, 1, 1);
                                         ...
                                         cudaStream_t stream)
{
  ...
  dim3 grid(raft::ceildiv(static_cast<uint64_t>(in1->nnz), TPB_X), 1, 1);
  dim3 blk(TPB_X, 1, 1);
  ...
  dim3 grid_n(raft::ceildiv(static_cast<uint64_t>(result->nnz), TPB_X), 1, 1);
}
